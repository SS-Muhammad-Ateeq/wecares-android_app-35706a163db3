...
import com.wecare.android.databinding.ItemServiceMainNoImageBinding;
import com.wecare.android.ui.base.BaseViewHolder;
import com.wecare.android.ui.sub.ServicesItemViewModel;
...
public class UserServicesAdapter extends RecyclerView.Adapter<BaseViewHolder> {
    ...
    public UserServicesAdapter(List<MainServiceModel> mainServiceModelList) {
    ...
    public BaseViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        ItemServiceMainNoImageBinding serviceMainBinding = ItemServiceMainNoImageBinding.inflate(LayoutInflater.from(parent.getContext()),
                parent, false);
    ...
    public class ServiceViewHolder extends BaseViewHolder implements ServicesItemViewModel.ServiceItemViewModelListener {
        ...
        private ItemServiceMainNoImageBinding mBinding;

        private ServicesItemViewModel mServicesItemViewModel;

        public ServiceViewHolder(ItemServiceMainNoImageBinding binding) {
