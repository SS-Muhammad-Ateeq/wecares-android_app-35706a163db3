...
public class OrderFragment extends BaseFragment<FragmentOrderBinding, OrderViewModel> implements OrderNavigator, CustomTabView.onTabClickListener, CurrentFragment.OnFragmentInteractionListener {
    ...
    private void initViews() {
        ...
        tabs.add(new CustomTabItem(0, getString(R.string.pending), true));
        tabs.add(new CustomTabItem(1, getString(R.string.accepted), false));
        tabs.add(new CustomTabItem(2, getString(R.string.previous), false));
    ...
    private void setupViewPager() {
        ...
        mViewPagerAdapter.addFragment(CurrentFragment.newInstance(AppConstants.ORDERS_STATUS_PENDING,this));
        mViewPagerAdapter.addFragment(CurrentFragment.newInstance(AppConstants.ORDERS_STATUS_ACCEPTED,this));
        mViewPagerAdapter.addFragment(PreviousFragment.newInstance());
    ...
    public void moveToFragment(int position) {
        tabsView.setSelectedTabID(position);
