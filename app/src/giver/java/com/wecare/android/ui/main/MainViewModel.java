...
import com.wecare.android.data.model.api.responses.LogoutResponse;
...
public class MainViewModel extends BaseViewModel<MainNavigator> {
    ...
    public MainViewModel(DataManagerFlavour dataManager, SchedulerProvider schedulerProvider) {
