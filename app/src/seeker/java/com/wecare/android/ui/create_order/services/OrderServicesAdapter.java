...
import com.wecare.android.databinding.ItemOrderServiceMainBinding;
import com.wecare.android.ui.base.BaseViewHolder;

import java.util.List;


public class OrderServicesAdapter extends RecyclerView.Adapter<BaseViewHolder> {
    ...
    public OrderServicesAdapter(List<MainServiceModel> serviceResponseList) {
...
//            default:
        ItemOrderServiceMainBinding serviceMainBinding = ItemOrderServiceMainBinding.inflate(LayoutInflater.from(parent.getContext()),
                parent, false);
        return new OrderServiceViewHolder(serviceMainBinding);
//        }
    }
...
//        }
    ...
    public class OrderServiceViewHolder extends BaseViewHolder implements OrderServicesItemViewModel.ServiceItemViewModelListener {

        private ItemOrderServiceMainBinding mBinding;

        private OrderServicesItemViewModel mServicesItemViewModel;

        public OrderServiceViewHolder(ItemOrderServiceMainBinding binding) {
        ...
        public void onBind(int position) {
            ...
            mServicesItemViewModel = new OrderServicesItemViewModel(service, this);
